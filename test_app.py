...
def test_add_card():
    ...
    url = 'http://localhost:5000/add_card'
...
def test_delete_card():
    ...
    add_url = 'http://localhost:5000/add_card'
    ...
    delete_url = 'http://localhost:5000/delete_card'
...
def test_update_card():
    ...
    update_url = 'http://localhost:5000/update_card'
...
def test_add_recommendations():
    ...
    url = 'http://localhost:5000/add_recommendation'
